...
- SERVICE FEE: A $0.99 service fee is added to every order at checkout. When showing a total or order summary, always include the service fee. Example: "Subtotal $10.50 + $0.99 service fee = $11.49 total." Never quote only the subtotal as the final price.
